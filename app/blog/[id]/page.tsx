...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  if (!blog) {
    return {
      title: "Publication Not Found | Raita Mitra Social Trust",
      description: "Specified article page could not be located in Raita Mitra database."
    };
  }

  return {
    title: `${blog.title} | Raita Mitra Editorial`,
    description: blog.summary,
    openGraph: {
      title: `${blog.title} | Raita Mitra Social Trust`,
      description: blog.summary,
      images: [
        {
          url: `https://picsum.photos/seed/${blog.coverImage || "farm"}/1200/630`,
          width: 1200,
          height: 630,
          alt: blog.title
        }
